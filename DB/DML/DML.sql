-- Active: 1692603283027@@127.0.0.1@3306@board
-- 회원가입
INSERT INTO 
user VALUES 
...
VALUES ('제목입니다.', '내용입니다.', '2023-08-20 20:40', 0, 0, 0, 'email@email.com');
...
SELECT * 
FROM board_list_view
WHERE write_datetime BETWEEN '2023-08-14 21:48' AND '2023-08-20 21:48'
...
SELECT * 
FROM board_list_view
WHERE write_email = 'email@email.com'
ORDER BY write_datetime DESC;
